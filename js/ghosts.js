...
function eatGhost(ghost) {
  if (eval("GHOST_" + ghost.toUpperCase() + "_STATE === 1")) {
    ...
    eval("GHOST_" + ghost.toUpperCase() + "_STATE = -1");
    eval(
      "GHOST_" + ghost.toUpperCase() + "_EAT_TIMER = new Timer(\"cancelEatGhost('" + ghost + "')\", GHOST_EAT_TIME)"
    );
...
function moveGhost(ghost) {
  if (eval("GHOST_" + ghost.toUpperCase() + "_MOVING === false")) {
    ...
    eval(
      "GHOST_" + ghost.toUpperCase() + "_MOVING_TIMER = setInterval(\"moveGhost('" + ghost + "')\", " + speed + ");"
    );
  } else {
...
function stopGhost(ghost) {
  if (eval("GHOST_" + ghost.toUpperCase() + "_STATE === 1")) {
    ...
    eval(
      "if(GHOST_" + ghost.toUpperCase() + "_EAT_TIMER !== null) GHOST_" + ghost.toUpperCase() + "_EAT_TIMER.cancel()"
    );
    eval("GHOST_" + ghost.toUpperCase() + "_EAT_TIMER = null");
    eval("GHOST_" + ghost.toUpperCase() + "_STATE = 0");
  }
...
function pauseGhost(ghost) {
  if (eval("GHOST_" + ghost.toUpperCase() + "_STATE === 1")) {
    ...
    eval(
      "if(GHOST_" + ghost.toUpperCase() + "_EAT_TIMER !== null) GHOST_" + ghost.toUpperCase() + "_EAT_TIMER.pause()"
    );
  }
...
function resumeGhost(ghost) {
  if (eval("GHOST_" + ghost.toUpperCase() + "_STATE === 1")) {
    ...
    eval(
      "if(GHOST_" + ghost.toUpperCase() + "_EAT_TIMER !== null) GHOST_" + ghost.toUpperCase() + "_EAT_TIMER.resume()"
    );
  }
  moveGhost(ghost);
}
